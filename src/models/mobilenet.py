...
def MobilenetModel(input_size, pretrained=False):
    ...
    position_output = dense_block(px, units=3, name='position', add_batchnorm=False, relu_activation=False)
    ...
    quat_output = dense_block(qx, units=4, name='orientation', add_batchnorm=False, relu_activation=False)
