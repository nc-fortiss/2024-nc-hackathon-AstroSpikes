...
from src.losses.poseloss import geodesic_dist, position_mse_loss, ori_error
from src.models import mobilenet, mobilenet_regression, mobilenet_heatmap
...
model_name = "networks/akida/model_hpe_100_16_no_encapsulation.keras"
input_size = (224,224,3)
output_directory ='/home/lecomte/Documents/spikingbody/output_front/'
model = mobilenet_heatmap.mobilenet_heatmap(input_size=input_size, num_keypoints=8)
...
cnn2snn.check_model_compatibility(model_quantized)
print("++++++++++++++++++MODEL COMPATIBLE+++++++++++++++++++++++++++++")
...
logging.info("Evaluation for model : " + model_name)
#infer(model, model_name, train_dataset, 1, resolution, down_network=1, down_input=1)
...
model_akida.save("2.13.0_akida_model")
model_akida.summary()
